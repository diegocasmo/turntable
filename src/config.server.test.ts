...
describe('configuration', () => {
  it.each(['APP_ORIGIN', 'RAILWAY_API_URL', 'SESSION_SECRET'])('rejects a missing %s', (name) => {
  ...
  it('rejects a non-Railway RAILWAY_API_URL hostname in production', () => {
    const name = 'RAILWAY_API_URL'
    const value = 'https://example.com/graphql'
