...
22. Keep each hand-maintained GraphQL result schema beside its operation. Bind the schema to the generated operation type. Share a schema only when the same domain rule applies.
