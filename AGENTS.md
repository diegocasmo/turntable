...
7. Keep each pull request at or below the added-line limit in [the Dangerfile](./dangerfile.ts). This count includes tests. There is no exception. Split the work instead.
