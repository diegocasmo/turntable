...
const badgeVariants = cva(
  'group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-control border border-transparent px-2 py-0.5 text-xs font-medium whitespace-nowrap transition-all focus-visible:border-focus focus-visible:ring-[3px] focus-visible:ring-focus/50 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 aria-invalid:border-danger aria-invalid:ring-danger/20 [&>svg]:pointer-events-none [&>svg]:size-3!',
  {
    variants: {
      variant: {
        default: 'bg-accent text-accent-contrast [a]:hover:bg-accent/80',
        secondary: 'bg-panel-raised text-text [a]:hover:bg-panel-raised/80',
        destructive: 'bg-danger/10 text-danger focus-visible:ring-danger/20 [a]:hover:bg-danger/20',
        outline: 'border-border text-text [a]:hover:bg-muted [a]:hover:text-text-muted',
        ghost: 'hover:bg-muted hover:text-text-muted',
