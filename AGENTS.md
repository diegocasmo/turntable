...
7. Keep each pull request at or below the added-line limit in [the Dangerfile](./dangerfile.ts). This count includes tests. Rule 8 defines the only excluded files. Split the work instead.
